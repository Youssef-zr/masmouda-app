...
<head>
    ...
    <title>{{ __("members.members_commitments_list_monthly") }}</title>
    <meta charset="UTF-8">
    <style>
        body {
    ...
    <div class="container">
        <div class="commitments">
            ...
            <div class="commitment-item" style="height:800px">
                ...
                <div class="content">
                    <h1 class="title text-underline">قــــرار الأداء الشهري</h1>
                ...
                <div class="decision-container">
                    ...
                    <div class="decision">
                        ...
                        <p class="text">
                             يحول لفائدة السيد(ة) : {{$member->name}}
                            بصفته: {{ $member->role->name_ar }}
                            بمبلغ قدره: {{ $member->role->salary }} درهم،
                            في حسابه(ا) البنكي رقم: <span dir="ltr">{{ $member->formatedRibNumber }}</span>
                            كتعويض عن شهر {{ now()->format("m") }}.
                        </p>
                    </div>
                    <div class="decision">
                        <h3 class="sub-title">
